          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all ${
                  themeClasses.darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300'
                }`}
              />
            </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {casosFiltrados.map((caso, index) => (
                  <tr 
                    ...
                    } hover:shadow-md group ${caso.slaStatus === 'Vencido' ? 'bg-red-50' : ''}`}
                  >
