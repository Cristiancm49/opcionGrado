...
const MisIncidencias = () => {
  ...
  const DetalleModal = () => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className={`${themeClasses.sidebarBg} rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto`}>
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              {esResuelto && casoSeleccionado.solucionAplicada && (
                <div>
                  ...
                  <p className={`${themeClasses.primaryText} p-4 border rounded-lg ${themeClasses.darkMode ? 'border-gray-600 bg-green-900/20' : 'border-green-300 bg-green-50'}`}>
              ...
              {esResuelto && casoSeleccionado.comentarioUsuario && (
                <div>
                  ...
                  <p className={`${themeClasses.primaryText} p-4 border rounded-lg ${themeClasses.darkMode ? 'border-gray-600 bg-blue-900/20' : 'border-blue-300 bg-blue-50'}`}>
          ...
          <div className="p-6">
            ...
            <div className="space-y-6">
              {preguntas.map((item, index) => (
                <div key={index} className={`p-4 border rounded-lg ${themeClasses.darkMode ? 'border-gray-600 bg-gray-700' : 'border-gray-300 bg-gray-50'}`}>
              ...
              {casoSeleccionado.comentarioUsuario && (
                <div className={`p-4 border rounded-lg ${themeClasses.darkMode ? 'border-gray-600 bg-blue-900/20' : 'border-blue-300 bg-blue-50'}`}>
                  <h3 className={`font-medium mb-3 ${themeClasses.primaryText}`}>
  ...
  return (
    <div className="max-w-full mx-auto">
      ...
      <div className={`${themeClasses.sidebarBg} rounded-xl p-4 shadow-lg mb-6 border ${themeClasses.darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className={`font-semibold ${themeClasses.primaryText}`}>Vista de Casos</h3>
              <p className={`text-sm ${themeClasses.secondaryText}`}>Selecciona el tipo de casos a mostrar</p>
            </div>
          </div>
      ...
      <div className={`${themeClasses.sidebarBg} rounded-xl shadow-lg mb-6 border ${themeClasses.darkMode ? 'border-gray-700' : 'border-gray-200'} overflow-hidden`}>
        <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className={`font-semibold ${themeClasses.primaryText}`}>Filtros Avanzados</h3>
                <p className={`text-sm ${themeClasses.secondaryText}`}>Refina tu búsqueda con filtros específicos</p>
              </div>
            </div>
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg flex items-center space-x-2 ${
                  themeClasses.darkMode 
                    ? 'bg-gray-600 text-white hover:bg-gray-700' 
      ...
      <div className={`${themeClasses.sidebarBg} rounded-xl shadow-lg overflow-hidden border ${themeClasses.darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
        <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
        ...
        {loading ? (
          <div className="p-12 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div>
                <p className={`font-medium ${themeClasses.primaryText}`}>Cargando incidencias...</p>
                <p className={`text-sm ${themeClasses.secondaryText}`}>Esto solo tomará un momento</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-12 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div>
                <p className={`font-medium ${themeClasses.primaryText}`}>No se encontraron incidencias</p>
                <p className={`text-sm ${themeClasses.secondaryText}`}>Ajusta los filtros para obtener resultados diferentes</p>
              </div>
            </div>
          </div>
        ) : (
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className={`text-sm font-semibold ${themeClasses.primaryText} group-hover:text-blue-600 transition-colors`}>
                            {caso.numeroCaso}
                          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {caso.estadoGeneral === 'RESUELTO' ? (
                        ...
                        <div className={`flex items-center space-x-2`}>
                          ...
                          <span className={`text-sm font-semibold ${caso.diasAbierto > 3 ? 'text-red-600' : themeClasses.primaryText}`}>
