    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className={textStyles.body2}>Cargando revisiones...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className={cn(textStyles.h5, 'mb-2')}>Error al cargar las revisiones</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className={textStyles.h1}>Revisión Administrativa</h1>
